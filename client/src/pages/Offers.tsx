    ...
    <main className="offers min-h-[100vh] bg-gray-800">
      <section className="offers__container py-[100px] w-full mx-auto max-w-6xl">
        ...
        <div className="offers__contents flex flex-col justify-center items-center text-white py-8 px-5 gap-9">
          ...
          {offers ? (
            <div className="offers__loyalty w-full max-w-4xl">
              <div className="offers__program flex justify-center items-start gap-8 p-8 border border-gray-500 bg-gray-700 rounded-3xl">
                <img src={Logo} alt="" className="w-[100px] h-full" />

                <div className="flex flex-col gap-3">
                  <h1 className="font-bold text-xl">
                    Pho Viet Loyalty Program
                  </h1>
                  <p>
                    Join our loyalty program and earn rewards with every vist!
                    The more you dine with us, the more benefits you unlock.
                    Points are earned for every dollar spent and can be redeemed
                    for special offers, free items, and exclusive experience.
                    Apply at the resturant!
                  </p>
                  <button className="border rounded-md border-gray-500 self-start px-4 py-1 bg-gradient-to-r from-orange-400 to-red-500">
                    Join Now
                  </button>
                </div>
              </div>

              <div className="offers__membership py-6 flex flex-col items-center justify-center gap-5">
                <h1 className="text-2xl">Membership Tiers & Benefits</h1>

                <div className="offers__tier grid grid-cols-3 gap-3">
                  <div className="border border-gray-500 border-t-yellow-900 border-t-8 rounded-lg py-6 px-4 flex flex-col gap-1 items-start justify-start">
                    ...
                    <div className="py-2">
                      ...
                      <ul className="px-4 list-disc">
                        ...
                        <li>Birthday special surprise</li>
                        <li>Early access to seasonal menus</li>
                      </ul>
                    </div>
                  </div>

                  <div className="border border-gray-500 border-t-slate-400 border-t-8 rounded-lg py-6 px-4 flex flex-col gap-1 items-start justify-start">
                    <h1 className="text-xl font-bold text-slate-300">
                      Silver Tier
                    </h1>
                    <p>Requirements: 5+ visits in 3 months</p>

                    <div className="py-2">
                      <h1 className="text-xl">Benefits:</h1>
                      <ul className="px-4 list-disc">
                        <li>10% off every order</li>
                        <li>Free appetizer with ramen purchase</li>
                  ...
                  <div className="border border-gray-500 border-t-amber-400 border-t-8 rounded-lg py-6 px-4 flex flex-col gap-1 items-start justify-start">
                    <h1 className="text-xl font-bold text-amber-300">
                      Gold Tier
                    </h1>
                    <p>Requirements: 12+ visits in 3 months</p>

                    <div className="py-2">
                      <h1 className="text-xl">Benefits:</h1>
                      <ul className="px-4 list-disc">
                        <li>15% off every order</li>
                        <li>Free premium topping on every visit</li>
                        <li>Reservations priority</li>
                        <li>Seasonal gift box</li>
                        <li>Invitation to chef's table events</li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <div className="Offers__contents-items grid grid-cols-2 gap-4">
              ...
              <div className="offers__contents-item border border-gray-600">
                ...
                <div className="p-4 grid grid-cols-1 gap-2">
                  <p className="text-gray-300">
                    Feed the whole family with our special bundle: 4 pho bowls,
                    2 side dishes, and 4 drinks at a discounted price.
                  </p>
                  <span className="flex justify-between items-center">
                    <p className="text-gray-500 text-sm">
                      Promo Code:{" "}
