      ...
      <div className="about">
        <div className="about__info px-5">
          ...
          <p className="about__description text-md md:text-lg lg:text-xl xl:text-xl">
            ...
            flavors straight from Vietnam to your table. Indulge in our
            signature pho, delicious spring rolls, and more in our cozy,
            welcoming atmosphere. Thank you for choosing Pho Viet—we can't wait
            to serve you!
          </p>
        </div>
